              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('Aromas Árabes', style: styleText3),
                  ),
                  const Aromas500(
                    title: 'Yara - Lattafa',
                    description: '''
...
class BuscadorAromas extends StatelessWidget {
  final String title;
  final String description;
  final String imageLocion;
  final String imageNotaSalida;
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 40),
                  child: Text('Acordes Principales', style: styleTextLocion100),
                ),
                const SizedBox(height: 10),
                MainChords2(
                  containerWidth: containerWidth,
...
class Aromas2000 extends StatelessWidget {
  final String title;
  final String description;
  final String imageLocion;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 60),
          child: Text('Notas de Fragancia:', style: styleTextLocion20),
        ),
        const SizedBox(height: 10),
        Row(
          children: [
