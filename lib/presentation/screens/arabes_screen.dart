...
class ArabesScreen extends StatefulWidget {
  const ArabesScreen({super.key});

  @override
  _ArabesScreenState createState() => _ArabesScreenState();
}
            ...
            : SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text('''
Bienvenidos a nuestra sección de Aromas Árabes, en este espacio te invitamos a descubrir una amplia gama de aromas Árabes, que capturan la
esencia de la elegancia. Desde aromas frescos y vibrantes hasta notas cálidas. Explora nuestra colección y encuentra el aroma perfecto.
Llévate tus aromas favoritos desde tan solo \$17.000. Elige el tamaño de tu loción en fl oz y luego la cantidad.
